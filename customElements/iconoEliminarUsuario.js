/**
 * Elemento icono eliminar usuario
 * 
 * Autor: SusanaGE
 * Fecha:16-12-2020
 */

class IconDeleteUser extends HTMLElement {
    constructor() {
        super();
    }
    connectedCallback(){
        this.innerHTML= `<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
...
customElements.define("icon-delete-user",IconDeleteUser);